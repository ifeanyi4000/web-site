...
import AllArchiveTithes from './titheRecords/AllArchiveTithes'
import { useGetAllOrdersArchivedQuery } from '../../redux/features/order/paytitheOrder'
import Loader from '../loader/Loader'
import NotificationIcon from '../notification/NotificationIcon'

type Props = {}

export default function ArchivedTithesLayout({ }: Props) {

    const { isLoading, data } = useGetAllOrdersArchivedQuery({})
            ...
            <div className=' h-screen overflow-x-hidden overflow-y-auto'>
                ...
                <div className='p-3'>
                    ...
                    <div className='flex flex-col md:flex-row gap-3 max-w-[80%'>
                        {isLoading ? <Loader /> : (
                            <AllArchiveTithes orderList={orderList} />
                        )}
                    </div>
