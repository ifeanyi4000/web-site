...
import { useGetAllOrdersBothQuery } from '../../../redux/features/order/paytitheOrder';
...
export default function AllArchiveTithes({ orderList }: Props) {
        ...
        { field: "createdAt", headerName: "Created At", flex: 0.5 },
        {
            field: "  ", headerName: "View", flex: 0.2, renderCell: (params: any) => {
                return (
                    <>
                        <Button
                            onClick={() => { setIsOpen(true); setId(params.id) }}
                        >
...
const Modal = ({ setIsOpen, id }: { setIsOpen: (isOpen: boolean) => void, id: any }) => {
    ...
    const { data: fetch } = useGetAllOrdersBothQuery({})
