...
import { MdDashboard, MdOutlineLiveTv } from "react-icons/md";
import { MdChecklistRtl } from "react-icons/md";
import { FaUserShield } from "react-icons/fa";
import { RiNotificationBadgeFill, RiSecurePaymentLine } from "react-icons/ri";
import { AiFillNotification } from "react-icons/ai";
import { MdHelp } from "react-icons/md";
import { GiTeacher } from "react-icons/gi";
import { SiGnuprivacyguard, SiGooglepodcasts } from "react-icons/si";
import { IoCloudOfflineSharp, IoLogOut } from "react-icons/io5";
import image from '../images/paytithe.png'
        ...
        <>
            {open && (
                <>
                    ...
                    ></div>
                    <div
                        className="fixed top-0 bottom-0 left-0 z-50 w-full h-screen max-w-xs border-r-2 bg-gray-900"
                        ...
                        <div className='mt-5 pt-3 px-3 rounded-md '>
                            ...
                            <Link to="/current-tithes">
                                <div className='flex gap-2 mb-3 text-xl font-medium font-serif cursor-pointer'>
                                    ...
                                    <div className='text-sm md:text-[15px] font-sans font-semibold text-white hover:text-blue-700'>Current Tithes</div>
                                </div>
                            </Link>
                            ...
                            <Link to="/podcast">
                                ...
                                <SiGooglepodcasts
                                        className='h-5 font-normal text-white' />
                                    <div className='text-sm md:text-[15px] font-sans font-semibold text-white hover:text-blue-700'>Podcasts</div>
                                </div>
                            </Link>
                            ...
                            <Link to="/privacy">
                                <div className='flex gap-2 mb-3 text-xl font-medium font-serif cursor-pointer'>
                                    ...
                                    <div className='text-sm md:text-[15px] font-sans font-semibold text-white hover:text-blue-700'>Privacy</div>
                                </div>
                            </Link>
                            <Link to="/payment-privacy">
                                <div className='flex gap-2 mb-3 text-xl font-medium font-serif cursor-pointer'>
                                    <RiSecurePaymentLine className='h-5 font-normal text-white' />
                                    <div className='text-sm md:text-[15px] font-sans font-semibold text-white hover:text-blue-700'>Payment Privacy</div>
                                </div>
                            </Link>
