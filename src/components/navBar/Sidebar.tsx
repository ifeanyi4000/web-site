...
import { FaMoneyBillTrendUp, FaStore, FaUserGroup } from "react-icons/fa6";
      ...
      <div className='px-[15px] pt-2'>
        <Link to="/">
          <div className='flex justify-center items-center py-2 '>
            <img src={image} alt='PayTithe' className=' h-[60px]' />
          </div>
        </Link>
        <div className='mt-5 border-t-2 pt-3 px-3 rounded-md border-blue-40'>
          ...
          <Link to="/cathedral">
            <div className='flex gap-2 mb-3 text-xl font-medium font-serif cursor-pointer'>
              ...
              <div className='text-sm md:text-[15px] font-sans font-semibold text-white hover:text-blue-700'>Seed</div>
            </div>
          </Link>
          ...
          <Link to="/payment-privacy">
            <div className='flex gap-2 mb-3 text-xl font-medium font-serif cursor-pointer'>
              ...
              <div className='text-sm md:text-[15px] font-sans font-semibold text-white hover:text-blue-700'>Terms of Payment</div>
            </div>
          </Link>
