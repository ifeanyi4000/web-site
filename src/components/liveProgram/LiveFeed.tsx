...
export default function LiveFeed({ }: Props) {
    ...
    const [createLiveFeed, { error, isSuccess, data }] = useCreateLiveFeedMutation({})
    const [updateLiveFeed, { error: errorx, isSuccess: success, data: datax }] = useUpdateLiveFeedMutation({})
