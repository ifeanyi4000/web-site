...
export default function SignIn({ }: Props) {
    ...
    return (
        ...
        <>
            {isLoading ? <Loader /> :
                <div className=' dark:bg-gray-900 flex justify-center py-2 items-center bg-opacity-25 inset-0 fixed top-0 bottom-0 right-0 left-0'>

                    <div className='w-[90%] md:w-[50%] lg:w-[25%] p-2 lg:p-4 scroll-m-3'>
                        <div className='flex justify-center items-center pb-4'>
                            <img src={images} alt='logo' className='h-[60px]' />
                        </div>

                        <div className='bg-gray-900 rounded-md p-2 lg:p-4 scroll-m-3'>
                            <div className='p-3 bg-white  rounded-md'>
                                <h1 className='text-[25px] md:text-[30px] lg:text-[35px] font-bold mb-3 text-center'>Login</h1>
                                ...
                                <div className='mt-3'>
                                    {/* <label className='text-base font-medium pb-2 text-gray-700 mt-2'>Email</label> */}
